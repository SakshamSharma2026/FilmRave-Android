...
import com.codewithshadow.filmrave.utils.Constants.BASE_YOUTUBE_URL
import com.codewithshadow.filmrave.utils.Constants.MEDIA_SEND_REQUEST_KEY
import com.codewithshadow.filmrave.utils.Constants.TEASER
import com.codewithshadow.filmrave.utils.Constants.TMDB_POSTER_IMAGE_BASE_URL_W342
import com.codewithshadow.filmrave.utils.Constants.TRAILER
import com.codewithshadow.filmrave.utils.Constants.YOUTUBE
import com.codewithshadow.filmrave.utils.NetworkResult
import com.codewithshadow.filmrave.utils.formatMediaDate
import com.codewithshadow.filmrave.utils.getLanguageTitle
import com.codewithshadow.filmrave.utils.getMovieGenreListFromIds
import com.codewithshadow.filmrave.utils.loadImage
import com.codewithshadow.filmrave.utils.showSharingDialog
...
class DetailsFragment : BottomSheetDialogFragment() {
    ...
    private fun openDetailsFragment(media: MovieResult) {
        val bundle = Bundle().apply {
            putString(MEDIA_SEND_REQUEST_KEY, Gson().toJson(media))
        }
    ...
    private fun setUpFragmentResultListeners() {
        ...
        args?.let {
            ...
            binding.apply {
                ...
                posterImage.loadImage(TMDB_POSTER_IMAGE_BASE_URL_W342.plus(imgUrl))
